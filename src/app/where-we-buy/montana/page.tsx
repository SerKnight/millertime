...
export default function Montana() {
  return (
    <RootLayout>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-primary/5 to-primary/10 p-8 sm:p-12 border border-primary/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="text-xs text-neutral-500 mt-1">Williston Basin</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-primary mb-2">180B</div>
        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
              Montana is home to the Williston Basin, one of the most productive oil and gas regions in North America.
            </p>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <FadeIn>
            <div className="rounded-3xl bg-white p-8 shadow-sm border border-neutral-200">
              <h3 className="font-display text-2xl font-semibold text-primary mb-4">Williston Basin</h3>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="text-neutral-600 space-y-1">
                    ...
                    <li>• 1.2 million acres under development</li>
                    <li>• Major operators: Continental Resources, Hess, Marathon Oil</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <FadeIn>
            <div className="rounded-3xl bg-white p-8 shadow-sm border border-neutral-200">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-primary mb-2">Primary Formations:</h4>
                  <p className="text-neutral-600">Niobrara, Shannon, Sussex, Parkman</p>
                </div>
                <div>
                  <h4 className="font-semibold text-primary mb-2">Production Type:</h4>
                  <p className="text-neutral-600">Oil and Natural Gas</p>
                ...
                <div>
                  <h4 className="font-semibold text-primary mb-2">Key Statistics:</h4>
                  <ul className="text-neutral-600 space-y-1">
                    <li>• 800+ active wells</li>
                    <li>• 400,000 acres under development</li>
                    <li>• Major operators: EOG Resources, Devon Energy</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-3xl bg-primary p-8 sm:p-12 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-neutral-300">Surface vs mineral ownership separation is prevalent in Montana</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-neutral-300">Montana offers competitive severance tax rates for mineral owners</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-neutral-300">Strong demand for Montana mineral rights from major operators</p>
              </div>
            </div>
          </div>
        </FadeIn>
      ...
      {/* Why Montana Landowners Trust Us */}
      <Container className="mt-16">
        <FadeIn>
          <div className="rounded-3xl bg-accent/5 p-8 sm:p-12 border border-accent/20">
            <h2 className="font-display text-3xl font-semibold text-primary mb-8 text-center">
              Why Montana Landowners Trust Miller Energy Group
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-600">Montana Transactions</div>
      ...
      <Container className="mt-16">
        <FadeIn>
          <div className="rounded-3xl bg-accent/5 p-8 sm:p-12 border border-accent/20 text-center">
            <h2 className="font-display text-3xl font-semibold text-primary mb-4">
              Ready to Discuss Your Montana Mineral Rights?
            </h2>
            <p className="text-neutral-600 mb-8 text-lg max-w-2xl mx-auto">
              Our team has deep expertise in Montana mineral rights. Get a confidential consultation and fair market valuation.
            </p>
            <a 
              href="/contact"
