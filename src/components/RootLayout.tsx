    ...
    <Container>
      <div className="flex items-center justify-between min-h-12">
        ...
        <div className="flex items-center gap-x-2 sm:gap-x-4">
          ...
          <Button href="/contact" invert={invert} className="bg-accent hover:bg-accent-dark text-white text-xs sm:text-sm px-3 sm:px-4">
            Get Free Valuation
          </Button>
          <button
            ref={toggleRef}
...
function NavigationItem({
  ...
  return (
    <Link
      href={href}
      className="group relative isolate -mx-6 bg-primary px-6 py-10 even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-primary-light sm:even:pl-16"
    >
      {children}
      ...
      <header>
        ...
        >
          <motion.div layout className="bg-neutral-800">
            ...
            <Navigation />
            <div className="relative bg-primary before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-primary-light">
              <Container>
